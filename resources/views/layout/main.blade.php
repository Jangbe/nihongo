...
<div class="navbar-fixed">
    <nav>
        <div class="nav-wrapper container">
            <a href="{{ url('/')}} " class="brand-logo"> 日本語</a>
            <a href="#" class="sidenav-trigger" data-target="sidenav"><i class="material-icons">menu</i></a>
            <ul class="right hide-on-med-and-down">
                <li class="@yield('1')"><a href="{{ url('/')}} ">Beranda</a></li>
                <li class="@yield('2')"><a href="{{ url('/prepolakalimat')}}">Kosakata & Pola Kalimat</a></li>
                <li class="@yield('3')"><a href="{{ url('/prequiz')}}">Quizz</a></li>
                <li class="@yield('4')"><a href="{{ url('/prequiz-huruf')}}">Huruf Jepang</a></li>
                <li class="@yield('5')"><a href="">Mondai</a></li>
            </ul>
        </div>
    </nav>
</div>
<ul class="sidenav" id="sidenav">
    <li class="@yield('1')"><a href="">Beranda</a></li>
    <li class="@yield('2')"><a href="{{ url('/prepolakalimat')}}">Kosakata & Pola Kalimat</a></li>
    <li class="@yield('3')"><a href="{{ url('/prequiz')}}">Quizz</a></li>
    <li class="@yield('4')"><a href="{{ url('/prequiz-huruf')}}">Huruf Jepang</a></li>
    <li class="@yield('5')"><a href="">Mondai</a></li>
